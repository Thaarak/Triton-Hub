...
def call_llm(user_text: str) -> str:
    ...
    # Try current Gemini models
    models = ["gemini-2.0-flash", "gemini-flash-latest", "gemini-2.5-flash", "gemini-pro-latest"]
    ...
    for model_id in models:
        try:
            ...
            if status_code == 429:
                print(f"Model {model_id} hit rate limit. Trying next model...", file=sys.stderr)
            else:
